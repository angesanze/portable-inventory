...
SPECTACULAR_SETTINGS = {
    ...
    'TAGS': [
        {'name': 'Widget', 'description': 'Embeddable widget endpoints (api_key auth): product listing, stock transactions, movements, QR token exchange, barcode resolution.'},
        {'name': 'Inventory', 'description': 'Location management, batch queries, and physical item tracking.'},
        {'name': 'QR Codes', 'description': 'Dynamic QR code lifecycle: info, configure, and lock.'},
        ...
        {'name': 'Settings', 'description': 'API key management, user management, and system configuration.'},
        {'name': 'Admin', 'description': 'Authenticated Authority Dashboard endpoints (JWT bearer).'},
        {'name': 'Auth', 'description': 'JWT token obtain/refresh.'},
        {'name': 'Platform', 'description': 'Superuser-only platform administration and per-tenant GDPR data export.'},
    ],
    'SECURITY': [
        {'BearerAuth': []},
        {'ApiKeyAuth': []},
