...
class TestSetTier:
    def test_promote_manager_to_developer(self):
        ...
        response = client.post(
            ...
            {'account_type': 'developer'}, format='json',
        )
    ...
    def test_demote_developer_with_children_rejected(self):
        ...
        Company.objects.create(
            name='Owned Tenant', account_type=Company.AccountType.MANAGER,
            parent=developer,
        )
        client, _superuser = _superuser_client()
        ...
        response = client.post(
            ...
            {'account_type': 'manager'}, format='json',
        )
