...
from .exceptions import QRCodeStateError, RateLimitExceededError
...
class DynamicQRCodeViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        if user.is_authenticated and user.company:
            ...
            is_configured = bool(data.get('product_model') or data.get('physical_product') or data.get('batch') or data.get('custom_url'))
    ...
    def perform_update(self, serializer):
        ...
        data = serializer.validated_data
        is_configured = bool(
            data.get('product_model', instance.product_model) or 
            data.get('physical_product', instance.physical_product) or 
            data.get('batch', instance.batch) or
            data.get('custom_url', instance.custom_url)
        )
