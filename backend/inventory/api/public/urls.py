...
urlpatterns = [
    ...
    path('resolve_barcode/', ProductWidgetViewSet.as_view({'get': 'resolve_barcode'}), name='widget-resolve-barcode'),
    path('<uuid:pk>/', ProductWidgetViewSet.as_view({'get': 'retrieve'}), name='widget-detail'),
    path('<uuid:pk>/transaction/', ProductWidgetViewSet.as_view({'post': 'transaction'}), name='widget-transaction'),
    ...
    path('create_location/', LocationWidgetViewSet.as_view({'post': 'create_location'}), name='widget-create-location'),
    path('location_inventory/', LocationWidgetViewSet.as_view({'get': 'location_inventory'}), name='widget-location-inventory'),
    path('work_orders/', WorkOrderWidgetViewSet.as_view({'get': 'list'}), name='widget-work-orders'),
    path('qr_info/', QRCodeWidgetViewSet.as_view({'get': 'qr_info'}), name='widget-qr-info'),
    path('configure_qr/', QRCodeWidgetViewSet.as_view({'post': 'configure_qr'}), name='widget-configure-qr'),
