...
from ..api.base import CompanyScopedMixin, ReadOnlyCompanyScopedViewSet, RoleGatedWriteMixin, bulk_delete_response, parse_bulk_delete_ids
...
class MovementViewSet(RoleGatedWriteMixin, CompanyScopedMixin, viewsets.ModelViewSet):
    ...
    def bulk_delete(self, request):
        ...
        scoped_ids = list(
            Movement.objects.filter(id__in=ids, product_model__company=company)
