...
from core.platform_metrics import (
    PlatformStatsView,
    PlatformGrowthView,
    PlatformApiUsageView,
    PlatformInsightsView,
    PlatformHealthView,
)
...
router.register(
    r"notification-channels", NotificationChannelViewSet, basename="notification-channel"
)
router.register(
    r"notification-deliveries", NotificationDeliveryViewSet, basename="notification-delivery"
)
...
urlpatterns = [
    ...
    path(
        "onboarding/", OnboardingViewSet.as_view({"post": "register"}), name="onboarding-register"
    ),
    ...
    path(
        "platform/stats/api-usage/", PlatformApiUsageView.as_view(), name="platform-stats-api-usage"
    ),
    path("platform/insights/", PlatformInsightsView.as_view(), name="platform-insights"),
    path(
        "platform/insights/health/", PlatformHealthView.as_view(), name="platform-insights-health"
    ),
    ...
    path(
        "products/<uuid:pk>/stock-series/", ProductSeriesView.as_view(), name="product-stock-series"
    ),
