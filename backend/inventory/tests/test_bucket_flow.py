...
def setup_data(db):
    ...
    return {"client": APIClient(), "key": api_key.key, "product": prod, "location": loc_wh}
...
def test_bucket_receive_and_consume(setup_data):
    ...
    payload_receive = {
        ...
        "quantity": 10,
        "reason": "Inbound Test",
        "batch_data": {"batch_identifier": "LOT-A", "data": {"expiry": "2025-01-01"}},
    ...
    payload_consume = {
        ...
        "calc_payload": {"operation": "subtract", "quantity": 5},
    }
