...
class TestExplicitFieldLists(TestCase):
    ...
    def test_work_order_serializer_has_explicit_fields(self):
        ...
        self.assertIsInstance(meta.fields, list, "WorkOrderSerializer should use an explicit field list")
    ...
    def test_event_log_serializer_has_explicit_fields(self):
        ...
        self.assertIsInstance(meta.fields, list, "EventLogSerializer should use an explicit field list")
        self.assertIn('id', meta.fields)
    ...
    def test_event_log_serializer_all_fields_read_only(self):
        ...
        for field in meta.fields:
            self.assertIn(field, meta.read_only_fields,
                          f"EventLog field '{field}' should be read-only")
