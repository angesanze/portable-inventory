...
from inventory.models import ProductModel, DynamicQRCode, Location, ProductBatch
...
class StockMethodsTest(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="testuser", password="password", company=self.company
        )
    ...
    def test_create_batch_product(self):
        ...
        move_payload = {
            ...
            "calc_payload": {"operation": "add", "quantity": 10},
        }
