...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--company', type=str, help='Name of the company to assign the product to (optional)')
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            self.stdout.write(self.style.SUCCESS(f'Successfully {action} product "{product.name}" (ID: {product.id})'))
