...
class ProductModel(models.Model):
    ...
    default_calculator = models.ForeignKey(CalculatorTemplate, on_delete=models.SET_NULL, null=True, blank=True, related_name='product_models')
    ...
    initial_balance = models.DecimalField(max_digits=19, decimal_places=4, default=0, help_text="Initial stock level for BULK tracking")
    ...
    def clean(self):
        ...
        if self.barcode:
            ...
            if not validate_gtin(self.barcode):
                raise _VE({'barcode': "Invalid barcode: must be a valid GTIN (EAN-8/EAN-13/UPC-A/GTIN-14)."})
