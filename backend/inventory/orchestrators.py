...
from .models import PhysicalProduct, WorkOrder
...
class InventoryOrchestrator:
    ...
    @staticmethod
    @transaction.atomic
    def handle_widget_movement(company, product_model, location, data: dict):
        """
        ...
        if (
            not physical_product
            and quantity < 0
            and product_model.tracking_mode == constants.TRACKING_MODE_INDIVIDUAL
        ):
